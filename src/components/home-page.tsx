      ...
      <header className="border-b bg-white/80 dark:bg-background/80 backdrop-blur sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button size="sm" onClick={() => setCreateOpen(true)} className="bg-emerald-500 hover:bg-emerald-600">
        ...
        {data.lessons.length === 0 ? (
          <Card className="border-dashed">
            <CardContent className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <Button onClick={() => setCreateOpen(true)} className="bg-emerald-500 hover:bg-emerald-600">
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <label className="text-xs text-emerald-600 hover:underline cursor-pointer">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleCreate} className="bg-emerald-500 hover:bg-emerald-600">Create</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={importOpen} onOpenChange={setImportOpen}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleImport} className="bg-emerald-500 hover:bg-emerald-600">Import</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
